    ...
    <html lang="en">
      <head>
        <link
          ...
          href="/apple-touch-icon.png"
        />
        <link rel="canonical" href="https://aejsinfo.com/" />
        ...
        <meta name="msapplication-TileColor" content="#da532c" />
        <meta name="theme-color" content="#ffffff" />
        <meta name="google-site-verification" content="4RhE729BjHbJDDlVgErYHpS0k3Y4Y4d6XUn3jn9ym3c" />
        <link rel="sitemap" type="application/xml" title="Sitemap" href="/sitemap.xml" />
        <meta name="msvalidate.01" content="60C25435936D208FD7AD97985F3D6F3E" />
        <meta name="yandex-verification" content="723e015616885af1" />

        {/* Google Analytics (gtag.js) */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-VPLHGFTK0C"></script>
        <script
          dangerouslySetInnerHTML={{
            __html: `
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "LocalBusiness",
              name: "AEJS INFO SERVICES PRIVATE LIMITED",
              image: "https://aejsinfo.com/_next/static/media/logo.c1840848.svg",
              url: "https://aejsinfo.com",
              telephone: "+91 9500475798",
              address: {
                "@type": "PostalAddress",
                streetAddress: "97, DAS Complex, 5th street Extension, 100 feet road, Behind Kalyan Jewellers, Coimbatore - 641 012",
                addressLocality: "COIMBATORE",
                addressRegion: "Tamilnadu",
                postalCode: "641012",
                addressCountry: "India",
              ...
              geo: {
                "@type": "GeoCoordinates",
                latitude: "10.988700", // Update latitude
                longitude: "76.956300", // Update longitude
              },
              openingHoursSpecification: [
                {
                  "@type": "OpeningHoursSpecification",
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              contactPoint: {
                ...
                address: {
                  "@type": "PostalAddress",
                  streetAddress: "97, DAS Complex, 5th street Extension, 100 feet road, Behind Kalyan Jewellers",
                  addressLocality: "Coimbatore",
                  addressRegion: "Tamilnadu",
                  postalCode: "641012",
                  addressCountry: "India",
